...
BOOST_FIXTURE_TEST_SUITE(when_turned_on, when_turned_on_)
	...
	BOOST_AUTO_TEST_CASE(displays_channel_one_by_default)
	{
	...
	BOOST_AUTO_TEST_CASE(can_not_select_previous_channel_when_not_selected_some_channel_for_the_first_time)
	{
		BOOST_CHECK(!tv.SelectPreviousChannel());
		BOOST_CHECK_EQUAL(tv.GetChannel(), 1);;
	}
